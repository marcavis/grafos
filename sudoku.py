...
class Sudoku():
    def __init__(self, preenchidos=[]):
        if preenchidos == []:
            self.preenchidos = self.novaListaDeVerticesPreenchidos()
        else:
    ...
    def novaListaDeVerticesPreenchidos(self):
        return [[None] * 9] * 9
    ...
    def colorir(self):
        lib_grafo.coloracaoSudoku(self.grafo,
        verticesColoridos = [[x, self.preenchidos[x]] for x in range(81)])
